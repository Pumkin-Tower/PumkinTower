...
ActorInit ZzrtlInitVars = {
    /**/ 437,
    /**/ ACTORCAT_ENEMY,//ACTORCAT_NPC, // tag as enemy for z-targeting text
    /**/ FLAGS,
    /**/ 419,
    /**/ sizeof(EnOsn),
    /**/ EnOsn_Init,
...
static AnimationInfo sAnimationInfo[] = {
    { (void*)(0x060201bc), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06002f74), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x060037c4), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06004320), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06004c8c), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x060094e4), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06009bb8), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x0600ac60), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06001614), 1.0f, 1.0f, 39.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06001034), 1.0f, 1.0f, 70.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x0600ae9c), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06003a1c), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x060055f8), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06007220), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x0600a444), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x060000c4), 0.0f, 0.0f, 0.0f, ANIMMODE_ONCE, 0.0f },
    { (void*)(0x060000c4), 0.0f, 1.0f, 1.0f, ANIMMODE_ONCE, 0.0f },
    { (void*)(0x06006d48), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06001d6c), 1.0f, 0.0f, 0.0f, ANIMMODE_ONCE, 0.0f },
    { (void*)(0x06002634), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06008d80), 1.0f, 0.0f, 0.0f, ANIMMODE_ONCE, 0.0f },
    { (void*)(0x06005d78), 1.0f, 0.0f, 0.0f, ANIMMODE_ONCE, 0.0f },
    { (void*)(0x06006564), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x0600a444), 1.0f, 0.0f, 0.0f, ANIMMODE_LOOP, 0.0f },
    { (void*)(0x06008d80), 0.0f, 77.0f, 0.0f, ANIMMODE_ONCE, 0.0f },
};
...
void EnOsn_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)(0x060202f0), (void*)(0x060201bc), NULL, NULL, 0);
...
void EnOsn_Update(Actor* thisx, PlayState* play) {
    ...
    if (Actor_ProcessTalkRequest(&this->actor, &play->state))
    {
        Message_StartTextbox(play, 4027, thisx);
    }
    else
    {
        thisx->textId = 4027; // fixes z-targeting text
        Actor_OfferTalk(&this->actor, play, 100.0f);
    }

    if (true || ENOSN_GET_TYPE(&this->actor) == OSN_TYPE_CHOOSE) {
        if (true || isSwitchFlagSet) {
            this->actor.flags |= ACTOR_FLAG_TARGETABLE;
...
void EnOsn_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx, Gfx** gfx) {
    ...
    if (((this->animIndex == OSN_ANIM_MASK_LOOK_AT) || (this->animIndex == OSN_ANIM_MASK_LOOK_FROM_START) ||
        ...
        gSPDisplayList((*gfx)++, (void*)(0x06002168));
        Matrix_Pop();
    }
}

void EnOsn_Draw(Actor* thisx, PlayState* play) {
    static TexturePtr sEyeClosedHappyTex = (void*)(0x060166f8);
    static TexturePtr sEyeOpenTex = (void*)(0x06016ef8);
    static TexturePtr sEyeClosedAngryTex = (void*)(0x060176f8);
    static TexturePtr sSmileTex = (void*)(0x06017ef8);
    static TexturePtr sFrownTex = (void*)(0x060182f8);
    s32 pad;
    EnOsn* this = THIS;
