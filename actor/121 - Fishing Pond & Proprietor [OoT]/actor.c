...
// which song to play
#define BACKGROUND_SONG NA_BGM_FAILURE_0 // was NA_BGM_CLEAR_EVENT before

// allow fishing for free
#define FISHING_COST 0//20
...
asm(" \
gFishingBubbleMaterialDL = 0x06003460; \
gFishingLureHookDL = 0x06012160; \
gFishingWaterDustMaterialDL = 0x060088C0; \
gFishingRainDropModelDL = 0x06003760; \
gFishingReedMaterialDL = 0x06014030; \
gFishingRodSegmentWhiteTex = 0x06011270; \
gFishingOwnerHairDL = 0x06007350; \
gFishingLoachAnim = 0x0600CFE0; \
gFishingRodSegmentDL = 0x06011410; \
gFishingLoachSkel = 0x06011058; \
gFishingOwnerHatDL = 0x060074C8; \
gFishingOwnerEyeHalfTex = 0x06009650; \
gFishingRockMaterialDL = 0x06013590; \
gFishingGroupFishModelDL = 0x0600C298; \
gFishingBassAnim = 0x0600007C; \
gFishingSinkingLureSegmentMaterialDL = 0x0600B950; \
gFishingRainSplashMaterialDL = 0x060039A8; \
gFishingSinkingLureSegmentModelDL = 0x0600B9C0; \
gFishingAquariumContainerDL = 0x06015470; \
gFishingLilyPadMaterialDL = 0x06013330; \
gFishingBubbleModelDL = 0x060034C0; \
gFishingWoodPostModelDL = 0x06013FD0; \
gFishingOwnerEyeOpenTex = 0x06009250; \
gFishingAquariumBottomDL = 0x060153D0; \
gFishingDustSplashMaterialDL = 0x06003610; \
gFishingStreamSplashDL = 0x06003230; \
gFishingRodSegmentStripTex = 0x06011070; \
gFishingRainSplashModelDL = 0x06003A18; \
gFishingRippleModelDL = 0x06008678; \
gFishingWoodPostMaterialDL = 0x06013F50; \
gFishingDustSplashModelDL = 0x06003680; \
gFishingRockModelDL = 0x06013610; \
gFishingLilyPadModelDL = 0x060133B0; \
gFishingGroupFishMaterialDL = 0x0600C220; \
gFishingReedModelDL = 0x060140B0; \
gFishingOwnerEyeClosedTex = 0x06009A50; \
gFishingOwnerAnim = 0x0600453C; \
gFishingRippleMaterialDL = 0x06008610; \
gFishingBassSkel = 0x060029C0; \
gFishingRodSetupDL = 0x060113D0; \
gFishingWaterDustModelDL = 0x06008970; \
gFishingRodSegmentBlackTex = 0x06011170; \
gFishingLineModelDL = 0x06003710; \
gFishingLureFloatDL = 0x060121F0; \
gFishingOwnerSkel = 0x060085F8; \
");
...
void EnFishing_Init(Actor* thisx, PlayState* play2) {
    ...
    if (thisx->params < 100) {
        ...
        //R_TIME_SPEED = 1; // turned this off; just let the scene/room handle it
        D_809171FC = 0;
        D_809171F6 = 10;
        ...
        // adjust water opacity directly since mm doesn't
        // have the oot sceneRenderInit function that does it
        *(((u8*)play->roomCtx.activeRoomVram) + 0x666f) = play->roomCtx.unk7A[0] + 127; // waterPrimA
        ...
        // changed signpost to custom unbreakable variation for pumkin tower
        Actor_SpawnAsChild(&play->actorCtx, thisx, play, 251/*ACTOR_EN_A_OBJ*//*ACTOR_EN_KANBAN*/, 53.0f, -17.0f, 982.0f, 0, 0, 0,
                           0x1509/*0x0315*//*ENKANBAN_FISHING*/);
    ...
    for (i = 0; i < EFFECT_COUNT; i++) {
        if (effect->type) {
            ...
            if (effect->type == FS_EFF_RIPPLE) {
                ...
                if (effect->unk_2C == 30) {
                    Message_StartTextbox(play, 0x40B3, NULL); // "WHAAAAAT?!? Why are you doing this to me? [...] I'm not going to let you get off that easy!" (50 rupee fine)
                }
...
void EnFishing_DrawRod(PlayState* play) {
    ...
    */
    float handTweak[] = { 600, 400, 400, 230, 230 }; // deity, goron, zora, deku, human
    Matrix_Translate(0.0f, handTweak[player->transformation], 0.0f, MTXMODE_APPLY);
    ...
    if (sLinkAge == 1) {
        if (HIGH_SCORE(HS_FISHING) & 0x7F) {
            if (HIGH_SCORE(HS_FISHING) & 0x80) {
                this->actor.textId = 0x40B1; // "The biggest fish ever caught in this pond weighed <FISH WEIGHT> pounds." (sinking lure variation)
            } else {
                this->actor.textId = 0x4089; // "The biggest fish ever caught in this pond weighed <FISH WEIGHT> pounds."
            }
        } else {
            this->actor.textId = 0x40AE; // "The biggest fish ever caught in this pond weighed <FISH WEIGHT> pounds." (the pond owner caught it)
        }
    } else if (HIGH_SCORE(HS_FISHING) & 0x7F000000) {
    ...
    if (this->unk_1CB == 0) {
        if (this->unk_1CC == 0) {
            ...
            if (Actor_ProcessTalkRequest(&this->actor, &play->state)) {
                TextOverride(play, "In memory of \x01""Aksa\x00, the first Zelda\x11""fan to go fishing in Majora's Mask.\xbf");
                //TextOverride(play, "In memory of \x01""Aksa\x00, the first Zelda\x11""fan who went fishing in Termina.\xbf");
    ...
    switch (this->unk_150) {
        ...
        case 6:
            ...
            switch (player->transformation)
            {
                ...
                case PLAYER_FORM_HUMAN: // base-game Young Link
                    sp10C.y = 10.0f;
                    sp10C.z = 50.0f;
                    break;
                
                case PLAYER_FORM_ZORA: // base-game Adult Link
                    sp10C.y = 30.0f;
                    sp10C.z = 55.0f;
                    break;
            ...
            if (this->unk_172[0] == 90) {
                ...
                if (this->unk_148 == 0) {
                    ...
                    if (D_8090CCF8 >= 75) {
                        D_809171DA = 0x409F; // "Oh my gosh! This fish is gigantic!! A fish this big can't even fit on the screen, and I can't weigh it accurately, but it looks like it's about %d pounds!! You'll want to keep this one, right?" (two choices: yes, no)
                    } else if (D_8090CCF8 >= 50) {
                        D_809171DA = 0x4091; // "Wow! This is a real lunker! Let's see...it weighs %d pounds! Do you want to keep it?" (two choices: yes, no)
                    } else {
                        D_809171DA = 0x4083; // "Well, well...it's about %d pounds. Do you want to keep it?" (two choices: yes, no)
                    }
                } else {
                    D_8090CCF8 = 2.0f * this->unk_1A4;
                    D_809171DA = 0x4099; // "Gosh! That's a strange fish you caught there! On top of that, it weighs %d pounds! What do you want to do with it?" (two choices: keep it, don't)
                }
                            ...
                            if (Message_ShouldAdvance(play)) {
                                ...
                                if (play->msgCtx.choiceIndex == 0) {
                                    if (D_8090CCF0 == 0.0f) {
                                        ...
                                        this->unk_1CD = 1;
                                        this->unk_172[0] = 0x3C;
                                        Message_StartTextbox(play, 0x4098, NULL); // "What? Huh? Oh? I think the fish you already kept was bigger than this one..." (keep it anyway? no, yes)
                                        TextOverride(play, "The fish you kept earlier is bigger.\x11""Keep this one instead?\x11\xc2\x02No\x11Yes\x00\xbf");
                                    } else {
...
{
/*
    // this test enables fishing instantly
...
*/
    ...
    switch (this->unk_154) {
        case 0:
            if (D_809171FC == 0) {
                u16 message = 0x03f6;
                if (FISHING_COST == 0) // alternate message for free fishing
                    message = 0x0873;
                if (sLinkAge != 1) {
                    if ((HIGH_SCORE(HS_FISHING) & 0x100) && !(HIGH_SCORE(HS_FISHING) & 0x200)) {
                        this->actor.textId = message;//0x4093; // "Hey, mister! I remember you! It's been a long time!"
                    } else {
                        this->actor.textId = message;//0x407B; // "Well, do you want to go fishing for 20 Rupees?"
                    }
                } else {
                    this->actor.textId = message;//0x407B; // "Well, do you want to go fishing for 20 Rupees?"
                }
            } else if (D_8090CD0C == 0) {
                this->actor.textId = 0x1212;//0x4084; // "What do you want? Choices: Weigh fish, talk, quit"
            } else {
                this->actor.textId = 0x1212;//0x4097; // "Hey, what are you doing? I told you not to do that!"
            }

            if (Actor_ProcessTalkRequest(&this->actor, &play->state)) {
                // XXX added this as a hotfix
                if (D_8090CD0C && play->msgCtx.currentTextId != 0x4097)
                {
                    Message_CloseTextbox(play);
                    Message_ContinueTextbox(play, 0x4097);
                    TextOverride(play, "Can I please have my hat back?\x11\x11\xc2\x02""Sure, sorry about that.\x11""It's mine now!\x00\xbf");
                }
                if (D_809171FC == 0) {
                    this->unk_154 = 1;
                    if (sLinkAge != 1) {
        ...
        case 1:
            if ((Message_GetState(&play->msgCtx) == TEXT_STATE_CHOICE) && Message_ShouldAdvance(play)) {
                ...
                switch (play->msgCtx.choiceIndex) {
                    case 0:
                        if (gSaveContext.save.saveInfo.playerData.rupees >= FISHING_COST) {
                            if (FISHING_COST > 0)
                                Rupees_ChangeBy(-FISHING_COST);
                            if (!Rumble_ControllerOneHasRumblePak()) {
                                this->actor.textId = 0x109E;//0x407C; // "Oh, no! You don't have a Rumble Pak!"
                            } else {
                                this->actor.textId = 0x109E;//0x407D; // "Wow! You have a Rumble Pak!"
                            }
                            this->actor.textId = 0x4567; // make text slow for custom override below
                            Message_ContinueTextbox(play, this->actor.textId);
                            TextOverride(play, "Don't forget to holler at Koizumi-san\x11""while you're here! Now happy fishing!\xe0\xbf"); // custom text to keep things short and simple
                            this->unk_154 = 2;
                            this->unk_154 = 5; // jump straight to fishing
                        } else {
                            Message_ContinueTextbox(play, 0x109D/*0x407E*/); // "Shucks! You don't have enough money."
                            this->unk_154 = 3;
                        }
                        break;

                    case 1:
                        Message_ContinueTextbox(play, 0x109C/*0x2D*/); // "All right. You don't have to play if you don't want to."
                        // restore oot text
                        TextOverride(play, "All right. You don't have to play\x11""if you don't want to.\x00\xbf");
                        this->unk_154 = 3;
                        break;
        ...
        case 2:
            if ((Message_GetState(&play->msgCtx) == TEXT_STATE_5) && Message_ShouldAdvance(play)) {
                Message_CloseTextbox(play);
                Message_ContinueTextbox(play, 0x407F); // "OK, listen up! Walk up to the water's edge and ..."
                this->unk_154 = 4;
            }
            break;
        ...
        case 4:
            if ((Message_GetState(&play->msgCtx) == TEXT_STATE_CHOICE) && Message_ShouldAdvance(play)) {
                ...
                switch (play->msgCtx.choiceIndex) {
                    case 0:
                        D_8090CCF8 = D_809171CC;
                        Message_ContinueTextbox(play, 0x4080); // "I'm so generous, I'll let you fish for as long as you want."
                        this->unk_154 = 5;
                        break;
        ...
        case 10:
            if (D_8090CD0C != 0) {
                if ((Message_GetState(&play->msgCtx) == TEXT_STATE_CHOICE) && Message_ShouldAdvance(play)) {
                    ...
                    switch (play->msgCtx.choiceIndex) {
                        case 0:
                            Message_ContinueTextbox(play, 0x40B2); // "You're a kind-hearted kid! But don't tell anyone about this. Seriously!"
                            TextOverride(play, "You're a kind-hearted kid!\x11""But don't tell anyone about this.\x11""Seriously!\xe0\xbf");
                            D_8090CD08 = 1;
                            D_8090CD0C = 0;
                            this->unk_154 = 20;
                            break;
                ...
                if ((Message_GetState(&play->msgCtx) == TEXT_STATE_CHOICE) && Message_ShouldAdvance(play)) {
                    ...
                    switch (play->msgCtx.choiceIndex) {
                        // weigh fish
                        case 100://case 0: // TODO excluding this feature for now
                            if (D_8090CCF0 == 0.0f) {
                                this->actor.textId = 0x408C; // "Hey, c'mon! You don't have a fish! Shucks!"
                                this->unk_154 = 20;
                            } else if (D_809171D0 == 0) {
                                D_8090CCF8 = D_8090CCF0;
                                if ((s16)D_809171CC < (s16)D_8090CCF0) {
                                    if (D_809171D2 == 2) {
                                        this->actor.textId = 0x40B0; // "YAHOOOOOO! This is HUGE!! A new record!!" (but you used sinking lure, so no prize)
                                    } else {
                                        this->actor.textId = 0x4086; // "WHOA! This fish is huge! [...] OK, here is your prize!"
                                    }
                                    this->unk_154 = 11;
                                } else {
                                    this->actor.textId = 0x408B; // "Well, it weighs %d pounds... Not bad, but there are bigger fish in there!"
                                    this->unk_154 = 20;
                                }
                            } else {
                                this->actor.textId = 0x409B; // "Well, well... WOW! What a rare fish! This is a Hyrule Loach! [...] I'll give you this prize!"
                                this->unk_154 = 11;
                            }
                            Message_ContinueTextbox(play, this->actor.textId);
                            break;
                        ...
                        // talk
                        case 101://case 1: // TODO excluding this feature for now
                            if (D_8090CD00 > 36000) {
                                D_8090CD00 = 30000;
                                Message_ContinueTextbox(play, 0x4088); // "Hey, young man! Don't you have anything important you should be doing?"
                            } else {
                                if (D_809171CA == 0) {
                                    if (D_809171D6 == 0) {
                                        D_809171D6++;
                                ...
                                if ((D_80917206 == 2) && (D_8090D638[D_809171D6] == 0x408D)) { // "You want to try another lure?" (suggests you can't)
                                    Message_ContinueTextbox(play, 0x40AF); // "What? Do you want to fish with a different lure?" (notices sinking lure)
                                } else {
                        ...
                        case 0://case 2:
                            if (D_809171D8 == 0) {
                                Message_ContinueTextbox(play, 0x28dc/*0x4085*/); // "Passion alone won't catch you many fish. I'm serious!"
                            } else if (sLinkAge == 1) {
                                Message_ContinueTextbox(play, 0x28dc/*0x4092*/); // "Come back when you get older! The fish will be bigger, too... Well, maybe."
                            }
                            this->unk_154 = 22;
                            break;
        ...
        case 21:
            if ((Message_GetState(&play->msgCtx) == TEXT_STATE_CHOICE) && Message_ShouldAdvance(play)) {
                ...
                switch (play->msgCtx.choiceIndex) {
                    ...
                    case 1:
                        if (D_809171D8 == 0) {
                            Message_ContinueTextbox(play, 0x4085); // "Passion alone won't catch you many fish. I'm serious!"
                        } else if (sLinkAge == 1) {
                            Message_ContinueTextbox(play, 0x4092); // "Come back when you get older! The fish will be bigger, too... Well, maybe."
                        }
                        this->unk_154 = 22;
                        break;
        ...
        case 24:
            ...
            if ((Message_GetState(&play->msgCtx) == TEXT_STATE_DONE) && Message_ShouldAdvance(play)) {
                if (D_809171D0 == 0) {
                    ...
                    Message_StartTextbox(play, 0x409C, NULL); // "Recently, the number of these fish has decreased tremendously, so I'm going to release this one."
                    this->unk_154 = 20;
                }
            }
            break;
...
void EnFishing_UpdateOwner(Actor* thisx, PlayState* play2) {
    ...
    if ((D_8090CD0C == 0) && (D_80917206 != 2) && (D_8090CD14 > 0) && (D_8090CD08 == 1) && (D_8090CD04 == 0)) {
        ...
        if ((sqrtf(SQ(dx) + SQ(dy) + SQ(dz)) < 35/*25.0f*/)) { // made this a little easier
            D_8090CD08 = 0;
            D_8090CD0C = 1;
            Message_StartTextbox(play, 0x4087, NULL); // "What? What are you doing to me?!"
            TextOverride(play, "What?\x11""What are you doing to me?!\x1c\x00\x3c\xbf");
        }
    }
    ...
    if (D_8090CCFC != 0) {
        D_8090CCFC--;
        if (D_8090CCFC == 0) {
            Message_StartTextbox(play, D_809171DA, NULL); // different messages for different fish sizes + strange fish
            // generic catch-all for every fish (custom)
            TextOverride(play, "Well, well...it's about \x01\x0e pounds\x00.\x11""Do you want to keep it?\x11""\xc2\x02Yes\x11No\x00\xbf");
            this->hasCaughtOneFish = true;
        }
    }
    ...
    if ((this->hasCaughtOneFish == false || D_809171FC != 0) && (D_8090CD4C == 0) && (player->actor.world.pos.z > 1360.0f) &&
    ...
    switch (D_8090CD4C) {
        ...
        case 10:
            ...
            Message_StartTextbox(play, 0x33b3/*0x409E*/, NULL); // "Hey! Hey! You can't take the rod out of here! When you quit fishing, return the rod to the counter. I'm serious!"
            D_8090CD4C = 11;
            Rumble_Override(0.0f, 150, 10, 10);
            
            // restore oot text
            TextOverride(play, "Hey! Hey!\x11""You can't take the rod out of\x11""here!\x10""When you quit fishing, return\x11""the rod to the counter.\x11""I'm serious!\x00\xbf");
            // hasn't caught fish
            if (this->hasCaughtOneFish == false)
                TextOverride(play, "No, no! You can't just leave\x11""without catching a fish first!\x11""Come back here!\x00\xbf");
            // fallthrough
        case 11:
            player->actor.world.pos.z = 1360.0f;
            player->actor.speed = 0.0f;
        ...
        case 20:
            ...
            sSubCamAt.y = mainCam->at.y;
            sSubCamAt.z = mainCam->at.z;
            Message_StartTextbox(play, 0x409A, NULL); // "Wow! Is this what I think it is? Astonishing! You snagged a sinking lure! What do you want to do with it?" (two choices: use it, don't)
            TextOverride(play, "Wow!\x10""Is this what I think it is?\x11""Astonishing!\x11""You snagged a \x01""sinking lure\x00!\x10""What do you want to do with it?\x11\x11\xc2\x02""Use it now.\x11""Get rid of it.\x00\xbf");
            D_8090CD4C = 21;
            D_80911F48 = 45.0f;
            D_8090CD50 = 10;
            // fallthrough
...
void EnFishing_DrawOwner(Actor* thisx, PlayState* play) {
    ...
    if (D_809171F6 != 0) {
        ...
        if (D_809171F6 == 0) {
            if (sLinkAge != 1) {
                SEQCMD_PLAY_SEQUENCE(SEQ_PLAYER_BGM_MAIN, 0, BACKGROUND_SONG | SEQ_FLAG_ASYNC);
            } else {
    ...
    if ((D_809171FC != 0) && D_8090CCF4) {
        Player* player = GET_PLAYER(play);
        bool canDraw = !(player->stateFlags3 & PLAYER_STATE3_1000); // don't draw rod while goron rolling
        if (canDraw)
