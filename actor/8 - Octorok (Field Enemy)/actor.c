...
asm(" \
    gOctorokHideAnim = 0x06003B24; \
    gOctorokAppearAnim = 0x0600466C; \
    gOctorokShootAnim = 0x0600044C; \
    gOctorokDieAnim = 0x06003958; \
    gOctorokSkel = 0x060033D0; \
    gOctorokFloatAnim = 0x06003EE4; \
    gOctorokProjectileDL = 0x06003250; \
    gOctorokHitAnim = 0x06004204; \
");
...
void func_8086F2FC(EnOkuta* this, PlayState* play) {
    ...
    if (this->actor.child != NULL) {
        this->actor.flags &= ~1;
        this->actor.flags |= 0x10;
        //this->actor.child->csId = this->actor.csId; Remove freezing cutscene
