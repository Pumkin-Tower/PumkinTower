...
#define FLAGS (ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_2 | ACTOR_FLAG_10 | ACTOR_FLAG_400)
...
void EnDh_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)(0x06007E88), (void*)(0x06005880), this->jointTable,
...
void EnDh_SetupWait(EnDh* this) {
    Animation_PlayLoop(&this->skelAnime, (void*)(0x06003A8C));
    this->curAction = DH_WAIT;
    this->actor.world.pos.x = Rand_CenteredFloat(280.0f) + this->actor.home.pos.x;
    this->actor.world.pos.z = Rand_CenteredFloat(280.0f) + this->actor.home.pos.z;
...
void EnDh_Wait(EnDh* this, PlayState* play) {
    ...
    if (explosive != NULL/* Actor_GetCollidedExplosive(play, &this->collider1.base) */) {
...
void EnDh_SetupWalk(EnDh* this) {
    Animation_Change(&this->skelAnime, (void*)(0x06003A8C), 1.0f, 0.0f,
                     Animation_GetLastFrame((void*)(0x06003A8C)) - 3.0f, ANIMMODE_LOOP, -6.0f);
...
void EnDh_Walk(EnDh* this, PlayState* play) {
    ...
    if ((play->gameplayFrames & 0x5F) == 0) {
        Actor_PlaySfx(&this->actor, NA_SE_EN_BOSU_LAUGH);
    }
...
void EnDh_SetupRetreat(EnDh* this, PlayState* play) {
    Animation_MorphToLoop(&this->skelAnime, (void*)(0x06005880), -4.0f);
...
void EnDh_SetupAttack(EnDh* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06004658), -6.0f);
...
void EnDh_Attack(EnDh* this, PlayState* play) {
    ...
    if (SkelAnime_Update(&this->skelAnime)) {
        ...
        Animation_Change(&this->skelAnime, (void*)(0x06004658), -1.0f, this->skelAnime.curFrame, 0.0f, ANIMMODE_ONCE,
                         -4.0f);
        this->actionState = 4;
    ...
    switch (this->actionState) {
        case 1:
            Animation_PlayOnce(&this->skelAnime, (void*)(0x06001A3C));
            this->actionState++;
            Actor_PlaySfx(&this->actor, NA_SE_EN_SUISEN_EAT);
            FALLTHROUGH;
        case 0:
        ...
        case 2:
            if (this->skelAnime.curFrame >= 4.0f) {
                ...
                this->collider2.elements[0].info.toucher.dmgFlags = 0x400000;
            ...
            if (this->collider2.base.atFlags & AT_BOUNCED) {
                ...
                func_800B8D98(play, &this->actor, 8.0f, this->actor.yawTowardsPlayer, 8.0f);
            }
            break;
        case 3:
            if ((this->actor.xzDistToPlayer <= 100.0f) && (Actor_IsFacingPlayer(&this->actor, 60 * 0x10000 / 360))) {
                Animation_Change(&this->skelAnime, (void*)(0x06004658), 1.0f, 20.0f,
                                 Animation_GetLastFrame((void*)(0x06004658)), ANIMMODE_ONCE, -6.0f);
                this->actionState = 0;
            } else {
                Animation_Change(&this->skelAnime, (void*)(0x06004658), -1.0f,
                                 Animation_GetLastFrame((void*)(0x06004658)), 0.0f, ANIMMODE_ONCE, -4.0f);
                this->actionState++;
                this->collider2.base.atFlags = this->collider2.elements[0].info.toucherFlags =
                    AT_NONE; // also TOUCH_NONE
                this->collider2.elements[0].info.toucher.dmgFlags = this->collider2.elements[0].info.toucher.damage = 0;
...
void EnDh_SetupBurrow(EnDh* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06002148), -6.0f);
    ...
    switch (this->actionState) {
        case 0:
            ...
            this->collider1.base.atFlags = this->collider1.info.toucherFlags =
                AT_ON | AT_TYPE_ENEMY; // also TOUCH_ON | TOUCH_SFX_WOOD
            this->collider1.info.toucher.dmgFlags = 0x400000;
...
void EnDh_SetupDamage(EnDh* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06003D6C), -6.0f);
...
void EnDh_Damage(EnDh* this, PlayState* play) {
    ...
    if (SkelAnime_Update(&this->skelAnime)) {
        ...
        if (this->retreat) {
            ...
            f32 frames = Animation_GetLastFrame((void*)(0x06004658));

            EnDh_SetupAttack(this);
            Animation_Change(&this->skelAnime, (void*)(0x06004658), 1.0f, 20.0f, frames, ANIMMODE_ONCE, -6.0f);
        } else {
            EnDh_SetupWalk(this);
        }
        this->unk_258 = 255;
...
void EnDh_SetupDeath(EnDh* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x060032BC), -1.0f);
...
void EnDh_Death(EnDh* this, PlayState* play) {
    if (SkelAnime_Update(&this->skelAnime) || (this->timer != 300)) {
        if (this->timer == 300) {
            Animation_PlayLoop(&this->skelAnime, (void*)(0x0600375C));
        }
        this->timer--;
        if (this->timer < 150) {
            if (this->alpha != 0) {
...
void EnDh_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.colChkInfo.health > 0) {
        ...
        if (((this->curAction != DH_DAMAGE) && (this->actor.shape.yOffset == 0.0f)) ||
            ((player->unk_ADC != 0) && (player->unk_ADD != this->unk_258))) {
...
void EnDh_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx, Gfx** gfx) {
...
void EnDh_Draw(Actor* thisx, PlayState* play) {
    ...
    if (this->drawDirtWave) {
        ...
        gSPDisplayList(POLY_XLU_DISP++, 0x06007FC0);
    }
