 ...
 * File: z_en_bw.c
 * Overlay: ovl_En_Bw
 * Description: Torch slug and Cryo slug and Ceiling Slugs
 */
...
void EnBw_SetupOnCeiling(EnBw* this);
void EnBw_OnCeiling(EnBw* this, PlayState* play);
void EnBw_SetupDropFromCeiling(EnBw* this, PlayState* play);
void EnBw_DropFromCeiling(EnBw* this, PlayState* play);
void EnBw_SetupFlipAfterCeilingDrop(EnBw* this);
void EnBw_FlipAfterCeilingDrop(EnBw* this, PlayState* play);
void EnBw_SetupShotDown(EnBw* this);
void EnBw_ShotDown(EnBw* this, PlayState* play);
...
static DamageTable sDamageTable_Ice = {
    /* Deku nut      */ DMG_ENTRY(0, 0x1),
    /* Deku stick    */ DMG_ENTRY(0, 0x0),
    /* Slingshot     */ DMG_ENTRY(2, 0xF),
    /* Explosive     */ DMG_ENTRY(2, 0xF),
    /* Boomerang     */ DMG_ENTRY(2, 0xF),
    /* Normal arrow  */ DMG_ENTRY(2, 0xF),
    /* Hammer swing  */ DMG_ENTRY(2, 0xF),
    ...
    /* Fire arrow    */ DMG_ENTRY(8, 0xD),
    /* Ice arrow     */ DMG_ENTRY(0, 0x0),
    /* Light arrow   */ DMG_ENTRY(2, 0xF),
    /* Unk arrow 1   */ DMG_ENTRY(2, 0xF),
    /* Unk arrow 2   */ DMG_ENTRY(0, 0x1),
    /* Unk arrow 3   */ DMG_ENTRY(2, 0xF),
    /* Fire magic    */ DMG_ENTRY(2, 0xF),
    /* Ice magic     */ DMG_ENTRY(0, 0x0),
    /* Light magic   */ DMG_ENTRY(0, 0x1),
    /* Shield        */ DMG_ENTRY(0, 0x0),
    /* Mirror Ray    */ DMG_ENTRY(0, 0x0),
...
void EnBw_Init(Actor* thisx, PlayState* play) {
    ...
    // non-default
    this->isCryoSlug = !!(params & 0x000f);
    this->isOnCeiling = !!(params & 0x00f0);

    Actor_SetScale(&this->actor, 0.012999999f);
    this->actor.gravity = -2.0f;
    SkelAnime_Init(play, &this->skelAnime, (void*)(0x060020F0), (void*)(0x06000228), this->jointTable,
                   this->morphTable, 12);
    ...
    func_809CE9A8(this);
    if (this->isOnCeiling) {
        EnBw_SetupOnCeiling(this);
        this->unk_248 = 0.0f;
    }
    if (this->isCryoSlug) {
        //this->actor.naviEnemyId = 0x2C;
        this->color1.a = this->color1.b = 255;
        this->color1.g = this->color1.r = 0; 
        this->actor.colChkInfo.damageTable = &sDamageTable_Ice;
    } else {
...
void func_809CE9A8(EnBw* this) {
    Animation_MorphToLoop(&this->skelAnime, (void*)(0x06000228), -2.0f);
    this->unk_220 = 2;
    ...
    switch (this->unk_221) {
        case 3:
            ...
            if ((this->unk_224 == 0) && (this->actor.xzDistToPlayer < 200.0f) &&
                (ABS(this->actor.playerHeightRel) < 50.0f) && Actor_IsFacingPlayer(&this->actor, 0x1C70)) {
                func_809CF72C(this);
            } else {
        ...
        case 0:
            ...
            if (sp64 == 0) {
                Math_SmoothStepToS(&this->actor.world.rot.y, this->actor.yawTowardsPlayer, 1,
                                   this->actor.speed * 1000.0f, 0);
                if ((this->actor.xzDistToPlayer < 90.0f) && (this->actor.playerHeightRel < 50.0f) &&
            ...
            if ((this->unk_224 == 0) || (ABS(this->actor.playerHeightRel) > 60.0f) ||
                (player2->stateFlags1 & (PLAYER_STATE1_2000 | PLAYER_STATE1_4000))) {
                this->unk_221 = 3;
                this->unk_224 = 150;
                this->unk_250 = 0.0f;
            }
...
void EnBw_SetupOnCeiling(EnBw* this) {
    ...
    this->unk_232 = 0;
    this->actor.speed = 0.0f;
    this->actor.shape.rot.z = 0x7FFF;
    EnBw_SetupAction(this, EnBw_OnCeiling);
}
...
void EnBw_OnCeiling(EnBw* this, PlayState* play) {
    ...
    fabsf(this->actor.world.pos.z - player->actor.world.pos.z) < 100.0f) {
        EnBw_SetupAction(this, EnBw_SetupDropFromCeiling);
...
void EnBw_SetupDropFromCeiling(EnBw* this, PlayState* play) {
    Animation_MorphToLoop(&this->skelAnime, (void*)(0x06002250), -1.0f);
    this->unk_220 = 6;
    this->unk_222 = 1000;
    this->unk_221 = 3;
    this->actor.speed = 0.0f;
...
void EnBw_SetupShotDown(EnBw* this) {
    ...
    this->unk_224 = 0xBB8;
    EnBw_SetupAction(this, EnBw_ShotDown);
    this->actor.shape.rot.z = 0; // rotate right-side-up so he doesn't disappear instantly upon landing
}
...
void func_809CF72C(EnBw* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x060021A0), -2.0f);
    this->unk_220 = 3;
    this->unk_221 = 0;
    this->unk_250 = 0.6f;
    this->unk_222 = 20;
...
void func_809CF8F0(EnBw* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06002250), -1.0f);
...
void func_809D0268(EnBw* this, PlayState* play) {
    if (this->isCryoSlug) {
        ...
        this->color1.g += 4;
        this->color1.r += 5;
        if (this->color1.b < 200) {
            this->color1.b = 200;
        }
        if (this->color1.g > 200) {
            this->color1.g = 200;
        }
        if (this->color1.r > 230) {
            this->color1.r = 230;
        }
    } else {
        this->color1.r -= 1;
...
u8 func_800355E4(PlayState* play, Collider* collider) {
    ...
    if ((collider->acFlags & AC_TYPE_PLAYER) && (player->meleeWeaponState != 0) &&
        (player->meleeWeaponAnimation == PLAYER_IMPACT_BONK)) {
        return true;
    } else {
        return false;
    }
    ...
    if (this->actor.colorFilterTimer == 0) {
        ...
        if (this->actor.colChkInfo.health != 0) {
            if ((this->unk_220 != 5) && (this->unk_220 != 6)) {
                ...
                this->color1.b = 255;
                if (this->isCryoSlug) {
                    this->color1.b = this->color1.g = 200;
                    this->color1.r = 255; 
                }
                this->unk_224 = 0x258;
                this->unk_221 = 1;
...
void func_809D0584(EnBw* this, PlayState* play) {
    if ((this->actor.bgCheckFlags & BGCHECKFLAG_CEILING) && (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
        ...
        if (this->collider2.base.acFlags & AC_HIT) {
            ...
            if (this->isOnCeiling && (this->actor.shape.rot.z == 0x7FFF)) {
                    EnBw_SetupShotDown(this);
                    Enemy_StartFinishingBlow(play, &this->actor);
        ...
        if ((play->actorCtx.unk2 != 0) && (this->actor.xzDistToPlayer <= 400.0f) &&
            (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND)) {
            if (this->unk_220 == 5) {
                this->unk_23C = 0;
                func_809CFF10(this);
...
void EnBw_Update(Actor* thisx, PlayState* play2) {
    ...
    Color_RGBA8 sp50_i = { 0, 200, 255, 255 };
    Color_RGBA8 sp4C_i = { 0, 80, 255, 255 };
    Color_RGBA8 sp48_i = { 0, 0, 0, 255 };
    Color_RGBA8 sp44_i = { 0, 0, 0, 220 };
    ...
    if (thisx->colChkInfo.damageEffect != 6) {
        ...
        if ((play->gameplayFrames & this->unk_221) == 0) {
            ...
            func_800B0EB0(play, &thisx->world.pos, &velocity, &accel, &sp50_i, &sp4C_i, 0x3C, 0, 0x14);
        }
        ...
        if ((play->gameplayFrames & this->unk_221) == 0) {
            ...
            accel.x = velocity.x * -0.075f;
            accel.z = velocity.z * -0.075f;
            func_800B0EB0(play, &thisx->world.pos, &velocity, &accel, &sp50, &sp4C, 0x3C, 0, 0x14);
        }
        ...
        if (this->unk_248 <= 0.4f) {
            ...
            if (((play->gameplayFrames & 1) == 0) && (this->unk_220 < 5) && (this->unk_23C == 0)) {
                ...
                func_800B0EB0(play, &thisx->world.pos, &velocity, &accel, &sp48_i, &sp44_i, 0xB4, 0x28,
                              20.0f - (this->unk_248 * 40.0f));
            }
        } else {
            this->collider1.info.toucher.effect = 2;
        }
        ...
        if (this->unk_248 <= 0.4f) {
            ...
            if (((play->gameplayFrames & 1) == 0) && (this->unk_220 < 5) && (this->unk_23C == 0)) {
                ...
                func_800B0EB0(play, &thisx->world.pos, &velocity, &accel, &sp48, &sp44, 0xB4, 0x28,
                              20.0f - (this->unk_248 * 40.0f));
            }
        } else {
...
s32 EnBw_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor* thisx, Gfx** gfx) {
    EnBw* this = (EnBw*)thisx;
    ...
    if (limbIndex == 1) {
        ...
        if ((this->unk_220 == 1) || (this->unk_220 == 5)) {
            ...
            Matrix_RotateXF(this->unk_258 * 0.115f, MTXMODE_APPLY);
            Matrix_RotateYF(this->unk_258 * 0.13f, MTXMODE_APPLY);
            Matrix_RotateZF(this->unk_258 * 0.1f, MTXMODE_APPLY);
...
void EnBw_Draw(Actor* thisx, PlayState* play2) {
    ...
    if (this->color1.a == 0xFF) {
        ...
        gSPSegment(POLY_OPA_DISP++, 0x08, &D_801AEF88[2]);
        POLY_OPA_DISP = SkelAnime_Draw(play, this->skelAnime.skeleton, this->skelAnime.jointTable,
                                       EnBw_OverrideLimbDraw, NULL, (void*)this, POLY_OPA_DISP);
    } else {
        ...
        gSPSegment(POLY_XLU_DISP++, 0x08, &D_801AEF88[0]);
        POLY_XLU_DISP = SkelAnime_Draw(play, this->skelAnime.skeleton, this->skelAnime.jointTable,
                                       EnBw_OverrideLimbDraw, NULL, (void*)this, POLY_XLU_DISP);
    }
    ...
    if (this->isCryoSlug) {
        ...
        gDPSetEnvColor(POLY_XLU_DISP++, 100, 200, 255, 0);
    }
...
/*     if (this->iceTimer != 0) {
        ...
        if ((this->iceTimer & 3) == 0) {
            ...
            //EffectSsEnIce_Spawn(play, &icepos, scale, velocity, Vec3f* accel, Color_RGBA8* primColor, Color_RGBA8* envColor, s32 life);
        }
    } */
