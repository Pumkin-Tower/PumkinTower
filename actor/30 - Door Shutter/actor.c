...
#define gBossDoorDL ((void*)0x060000C0)
#define gameplay_keep_DL_077990 ((void*)0x04077990)
#define gameplay_keep_DL_078A80 ((void*)0x04078A80)
#define object_numa_obj_DL_007150 ((void*)0x06007150)
#define object_hakugin_obj_DL_000128 ((void*)0x06000128)
#define gGreatBayTempleObjectDoorDL ((void*)0x06017D00)
#define object_ikana_obj_DL_014A40 ((void*)0x06014A40)
#define gBeneathTheWellSlidingDoorDL ((void*)0x060001A0)
#define object_ikninside_obj_DL_004440 ((void*)0x06004440)
#define object_ikninside_obj_DL_005260 ((void*)0x06005260)
#define gSecretShrineSlidingDoorDL ((void*)0x06000190)
#define gSwampSpiderHouseSlidingDoorDL ((void*)0x06000198)
#define object_kaizoku_obj_DL_0001A0 ((void*)0x060001A0)
#define object_last_obj_DL_0039C0 ((void*)0x060039C0)
#define gBossDoorDefaultTex ((void*)0x06006BA0)
#define gBossDoorWoodfallTex ((void*)0x06005BA0)
#define gBossDoorSnowheadTex ((void*)0x060005C0)
#define gBossDoorGreatBayTex ((void*)0x06004BA0)
#define gBossDoorStoneTowerTex ((void*)0x06003BA0)
...
ShutterSceneInfo D_808A2258[] = {
    // new data, so doors work everywhere + stone tower
    { SCENE_SEA, 4 }, { SCENE_SEA, 4 }, { SCENE_SEA, 4 },
    { SCENE_SEA, 4 }, { SCENE_SEA, 4 }, { SCENE_SEA, 4 },
    { SCENE_SEA, 4 }, { SCENE_SEA, 4 }, { SCENE_SEA, 4 },
    { SCENE_SEA, 4 }, { SCENE_SEA, 4 }, { SCENE_SEA, 4 },
    { SCENE_SEA, 4 }, { SCENE_SEA, 4 }, { SCENE_SEA, 4 },
    { SCENE_SEA, 4 }, { SCENE_SEA, 4 }, { -1, 1 },
    /* // original data
...
s32 DoorShutter_SetupDoor(DoorShutter* this, PlayState* play) {
    ...
    if (doorType == 1) {
        if ((this->doorType != 7 && !Flags_GetClear(play, this->slidingDoor.dyna.actor.room))
            // XXX hotfix to prevent unlocked doors from temporarily barring behind link
            || (this->doorType == 7 && !Flags_GetSwitch(play, DOORSHUTTER_GET_SWITCH_FLAG(&this->slidingDoor.dyna.actor)))
        ) {
...
void func_808A0F88(DoorShutter* this, PlayState* play) {
    if ((Flags_GetClear(play, this->slidingDoor.dyna.actor.room) ||
        ...
        // XXX hotfix to not require clear trigger:
        ...
        if (CutsceneManager_IsNext(this->csId)) {
            ...
            if (this->doorType != 7) // XXX hotfix to not require clear trigger
        ...
        // this code fixes camera freeze on door unlock cutscene
...
void func_808A1784(DoorShutter* this, PlayState* play) {
    if (this->unk_167 != 0) {
        ...
        //Audio_RestorePrevBgm(); // XXX commented out to fix background music stopping on miniboss
                                  //     defeat b/c it was causing our music to stop playing
    }
}
