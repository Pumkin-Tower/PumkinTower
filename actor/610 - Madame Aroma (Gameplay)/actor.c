...
asm(" \
gMadameAromaShawlLeftLowerDL = 0x060057D0; \
gMadameAromaShawlLeftLowerMiddleDL = 0x06005878; \
gMadameAromaShawlRightLowerDL = 0x06005680; \
object_al_Anim_00DBE0 = 0x0600DBE0; \
gMadameAromaShawlUpperDL = 0x06005920; \
object_al_Anim_00CA28 = 0x0600CA28; \
gMadameAromaSkel = 0x0600A0D8; \
gMadameAromaShawlMiddleDL = 0x06006598; \
object_al_Anim_000C54 = 0x06000C54; \
object_al_Anim_00BCA4 = 0x0600BCA4; \
gMadameAromaShawlRightLowerMiddleDL = 0x06005728; \
object_al_Anim_00A764 = 0x0600A764; \
object_al_Anim_00ACA0 = 0x0600ACA0; \
");
...
MsgScript* func_80BDEABC(EnAl* this, PlayState* play) {
    ...
    // XXX always say the same thing, message 0x2A9D for both debug and production
    return D_80BDFE84;
