...
#define FLAGS (ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_2 | ACTOR_FLAG_10)
...
void EnDha_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)(0x06000BD8), (void*)(0x060015B0), this->jointTable,
                       this->morphTable, 4);
...
void EnDha_SetupWait(EnDha* this) {
    Animation_PlayLoop(&this->skelAnime, (void*)(0x060015B0));
    this->unk_1C0 = 0;
...
void EnDha_Wait(EnDha* this, PlayState* play) {
    ...
    if (this->actor.xzDistToPlayer <= 100.0f) {
        ...
        if (Math_Vec3f_DistXYZ(&playerPos, &this->handPos[0]) <= 12.0f) {
            ...
            func_800BE33C(&this->handPos[1], &playerPos, &this->handAngle, 0);
        ...
        func_800BE33C(&this->armPos, &this->handPos[0], &angle, 0);
        ...
        func_800BE33C(&this->actor.world.pos, &this->armPos, &angle, 0);
        Matrix_RotateZYX(angle.x, angle.y, 0, MTXMODE_APPLY);
    ...
    if (angle == 0) {
        ...
        if (this->actionTimer != 0) {
            if (-12000.0f < this->actor.shape.yOffset) {
                ...
                func_800BBFB0(play, &vec, 7.0f, 1, 0x5A, 0x14, 1);
            } else {
                this->actionTimer--;
...
void EnDha_Update(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.parent == NULL) {
        this->actor.parent = Actor_FindNearby(play, &this->actor, 31, ACTORCAT_ENEMY, 10000.0f);
    }
...
s32 EnDha_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor* thisx) {
    EnDha* this = (EnDha*)thisx;
...
void EnDha_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx) {
...
void EnDha_Draw(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_DrawFlexOpa(play, this->skelAnime.skeleton, this->skelAnime.jointTable, this->skelAnime.dListCount,
                          EnDha_OverrideLimbDraw, EnDha_PostLimbDraw, (void*)this);
}
