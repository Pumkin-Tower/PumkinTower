...
#define gameplay_dangeon_keep_DL_017EA0 ((void*)0x05017ea0)
#define gameplay_dangeon_keep_DL_018090 ((void*)0x05018090)
#define gMagicPotDL ((void*)0x06000278)
#define gMagicPotShardDL ((void*)0x06001610)
#define gPotDL ((void*)0x060017c0)
#define gPotShardDL ((void*)0x06001960)
...
void func_80927690(ObjTsubo* this, PlayState* play) {
    ...
    if (this->enemyType)
    {
        ...
        {
            case Stalfos: actor = 0x0040; param = 0x0001; break;
        }
        
        if (actor)
            Actor_Spawn(&play->actorCtx, play, actor, this->actor.world.pos.x, this->actor.world.pos.y,
                this->actor.world.pos.z, 0, 0, 0, param);
...
s32 ObjTsubo_IsSceneNotGohtOrTwinmold(ObjTsubo* this, PlayState* play) {
    return false; // make magic green vases always respawn
...
void ObjTsubo_Init(Actor* thisx, PlayState* play) {
    ...
    //this->actor.params = 0x0103; // testing enemy spawns
    switch (OBJ_TSUBO_P003F(&this->actor))
    {
        case 3: this->enemyType = Stalfos; break;
    }
