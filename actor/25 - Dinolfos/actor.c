...
void EnDinofos_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)(0x06009570), (void*)(0x06002e40), this->jointTable, this->morphTable,
                       DINOLFOS_LIMB_MAX);
...
void func_8089B100(EnDinofos* this, PlayState* play) {
    ...
    Animation_Change(&this->skelAnime, (void*)(0x06001ccc), 1.0f, Animation_GetLastFrame((void*)(0x06001ccc)),
                     Animation_GetLastFrame((void*)(0x06001ccc)), ANIMMODE_ONCE, 0.0f);
...
void func_8089B4A4(EnDinofos* this) {
    ...
    Animation_PlayOnce(&this->skelAnime, (void*)(0x0600c974));
...
void func_8089B6E8(EnDinofos* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06009b70), -3.0f);
...
void func_8089B7B0(EnDinofos* this) {
    Animation_MorphToLoop(&this->skelAnime, (void*)(0x06002e40), -4.0f);
...
void func_8089B8B0(EnDinofos* this, PlayState* play) {
    ...
    if (this->actionFunc != func_8089B98C) {
        Animation_MorphToLoop(&this->skelAnime, (void*)(0x06000580), -4.0f);
        if (Actor_OtherIsTargeted(play, &this->actor)) {
            phi_f0 = 170.0f;
        } else {
            phi_f0 = 70.0f;
...
void func_8089BBB4(EnDinofos* this, PlayState* play) {
    ...
    if (this->actionFunc != func_8089BD28) {
        ...
        if (this->actionFunc == func_8089D1E0) {
            ...
            Animation_Change(&this->skelAnime, (void*)(0x0600d62c), this->actor.speed * 0.166666671634f, 0.0f, 0.0f,
                             ANIMMODE_LOOP, -4.0f);
        }
...
void func_8089C024(EnDinofos* this, s32 arg1) {
    if (arg1 == 0) {
        Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06001ccc), 2.0f);
        func_8089AD70(this);
    } else {
        Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06001ccc), -1.0f);
        if ((arg1 == 2) || (arg1 == 3)) {
...
void func_8089C2A8(EnDinofos* this, PlayState* play) {
    ...
    if ((this->actor.velocity.y < 0.0f) && (this->skelAnime.animation == (void*)(0x06001ccc))) {
        this->colliderQuad.base.atFlags |= AT_ON;
        this->colliderJntSph.base.acFlags |= AC_ON;
        Animation_Change(&this->skelAnime, (void*)(0x060025b4), 1.0f, 7.0f, 13.0f, ANIMMODE_ONCE, -2.0f);
    }
...
void func_8089C398(EnDinofos* this) {
    if (this->actionFunc != func_8089C2A8) {
        Animation_PlayOnce(&this->skelAnime, (void*)(0x06000af0));
    } else {
        this->skelAnime.endFrame = Animation_GetLastFrame((void*)(0x060025b4));
    }
...
void func_8089C4F8(EnDinofos* this) {
    Animation_PlayOnce(&this->skelAnime, (void*)(0x060025b4));
...
void func_8089C690(EnDinofos* this) {
    Animation_Change(&this->skelAnime, (void*)(0x060025b4), -1.0f, this->skelAnime.curFrame, 0.0f, ANIMMODE_ONCE,
                     0.0f);
...
void func_8089C87C(EnDinofos* this, s32 arg1) {
    Animation_PlayOnce(&this->skelAnime, (void*)(0x0600d21c));
...
void func_8089CA14(EnDinofos* this) {
    Animation_MorphToPlayOnce(&this->skelAnime, (void*)(0x06001040), -5.0f);
    this->colliderJntSph.base.acFlags |= AC_ON;
    this->actor.speed = 0.0f;
    this->actor.world.rot.y = this->actor.shape.rot.y;
...
void func_8089CB10(EnDinofos* this, PlayState* play) {
    ...
    Animation_PlayLoop(&this->skelAnime, (void*)(0x060013c0));
    this->unk_290 = 20;
    this->actor.speed = 0.0f;
...
void func_8089CF00(EnDinofos* this, PlayState* play) {
    Animation_PlayOnce(&this->skelAnime, (void*)(0x060017b8));
    this->colliderJntSph.base.atFlags &= ~AT_ON;
    if (play->sceneId == SCENE_MITURIN) {
        play->envCtx.lightSettingOverride = LIGHT_SETTING_OVERRIDE_NONE;
    }
...
void func_8089CFAC(EnDinofos* this) {
    Animation_PlayOnce(&this->skelAnime, (void*)(0x0600abd0));
...
void func_8089D11C(EnDinofos* this, s16 arg1) {
    ...
    Animation_Change(&this->skelAnime, (void*)(0x0600d62c), this->actor.speed * (1.0f / 7.5f), 0.0f, 0.0f,
                     ANIMMODE_LOOP, -4.0f);
    this->actor.world.rot.y = BINANG_ADD(this->actor.shape.rot.y, 0x4000);
    this->unk_292 = 10;
    this->unk_2A4 = 0.0f;
