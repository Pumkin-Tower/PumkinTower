...
#define FLAGS (ACTOR_FLAG_TARGETABLE | ACTOR_FLAG_2)
...
void EnDodojr_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_Init(play, &this->skelAnime, (void*)(0x060020E0), (void*)(0x060009D4), this->jointTable,
                   this->morphTable, 15);
...
void EnDodojr_SetupCrawlTowardsTarget(EnDodojr* this) {
    f32 lastFrame = Animation_GetLastFrame((void*)(0x06000860));

    Animation_Change(&this->skelAnime, (void*)(0x06000860), 1.8f, 0.0f, lastFrame, ANIMMODE_LOOP_INTERP, -10.0f);
    this->actor.velocity.y = 0.0f;
...
void EnDodojr_SetupFlipBounce(EnDodojr* this) {
    f32 lastFrame = Animation_GetLastFrame((void*)(0x060004A0));

    Animation_Change(&this->skelAnime, (void*)(0x060004A0), 1.0f, 0.0f, lastFrame, ANIMMODE_ONCE, -10.0f);
...
void EnDodojr_SetupSwallowedBombDeathSequence(EnDodojr* this) {
    f32 lastFrame = Animation_GetLastFrame((void*)(0x060005F0));

    Animation_Change(&this->skelAnime, (void*)(0x060005F0), 1.0f, 0.0f, lastFrame, ANIMMODE_LOOP, 0.0f);
    this->actor.velocity.y = 0.0f;
    this->actor.gravity = -0.8f;
}

void EnDodojr_SetupJumpAttackBounce(EnDodojr* this) {
    f32 lastFrame = Animation_GetLastFrame((void*)(0x06000724));

    Animation_Change(&this->skelAnime, (void*)(0x06000724), 1.0f, 0.0f, lastFrame, ANIMMODE_LOOP, -10.0f);
    this->actor.gravity = -0.8f;
    this->counter = 3;
    this->actor.velocity.y = 10.0f;
}
...
void EnDodojr_SetupEatBomb(EnDodojr* this) {
    Animation_Change(&this->skelAnime, (void*)(0x06000724), 1.0f, 8.0f, 12.0f, ANIMMODE_ONCE, 0.0f);
...
s32 EnDodojr_CheckNearbyBombs(EnDodojr* this, PlayState* play) {
    ...
    bomb = play->actorCtx.actorLists[ACTORCAT_EXPLOSIVES].first;
    this->bomb = NULL;
...
void EnDodojr_WaitUnderground(EnDodojr* this, PlayState* play) {
    ...
    if (!(this->actor.xzDistToPlayer >= 320.0f)) {
        ...
        if (!(dist >= 40.0f)) {
            Animation_Change(&this->skelAnime, (void*)(0x06000860), 1.8f, 0.0f, lastFrame, ANIMMODE_LOOP_INTERP,
                             -10.0f);
