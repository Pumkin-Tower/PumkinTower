...
void EnMag_DrawInner(Actor* thisx, PlayState* play, Gfx** gfxp) {
    ...
    static TexturePtr sAppearEffectMaskTextures[] = {
        (void*)(0x0600cf40), (void*)(0x0600d740), (void*)(0x0600ef40),
        (void*)(0x0600df40), (void*)(0x0600e740), (void*)(0x0600f740),
    }; // Visible when mask appearing
    static TexturePtr sDisplayEffectMaskTextures[] = {
        (void*)(0x06009f40), (void*)(0x0600a740), (void*)(0x0600bf40),
        (void*)(0x0600af40), (void*)(0x0600b740), (void*)(0x0600c740),
    }; // Visible when full game logo displayed
    static TexturePtr sEffectTextures[] = {
        (void*)(0x0600ff40), (void*)(0x06010340), (void*)(0x06010340),
        (void*)(0x06010740), (void*)(0x06010b40), (void*)(0x06010b40),
    };
    ...
    if (this->majorasMaskAlpha != 0) {
        ...
        EnMag_DrawImageRGBA32(&gfx, MAJORAS_MASK_TEX_CENTER_X, MAJORAS_MASK_TEX_CENTER_Y, (void*)(0x06011e48),
    ...
    if (this->subtitleAlpha != 0) {
        ...
        EnMag_DrawTextureI8(&gfx, (void*)(0x06009680), SUBTITLE_TEX_WIDTH, SUBTITLE_TEX_HEIGHT,
    ...
    EnMag_DrawTextureI8(&gfx, (void*)(0x06009000), SUBTITLE_TEX_WIDTH, SUBTITLE_TEX_HEIGHT,
                        SUBTITLE_TEX_LEFT, SUBTITLE_TEX_TOP);
    ...
    if (this->mainTitleAlpha != 0) {
        ...
        EnMag_DrawImageRGBA32(&gfx, ZELDA_TEX_CENTER_X, ZELDA_TEX_CENTER_Y, (void*)(0x06000000), ZELDA_TEX_WIDTH,
                              ZELDA_TEX_HEIGHT);
        ...
        EnMag_DrawTextureI8(&gfx, (void*)(0x06009d00), THE_LEGEND_OF_TEX_WIDTH, THE_LEGEND_OF_TEX_HEIGHT,
    ...
    if (this->copyrightAlpha != 0) {
        ...
        EnMag_DrawTextureIA8(&gfx, (void*)(0x06010f40), COPYRIGHT_TEX_WIDTH, COPYRIGHT_TEX_HEIGHT,
    ...
    if (gSaveContext.fileNum == 0xFEDC) {
        ...
        gDPLoadTextureBlock_4b(gfx++, (void*)(0x06011740), G_IM_FMT_I,
        ...
        gDPSetPrimColor(gfx++, 0, 0, 0, 0, 0, sTextAlpha);
        gDPLoadTextureBlock_4b(gfx++, (void*)(0x06011bc0), G_IM_FMT_I, NO_CONTROLLER_SECOND_TEX_WIDTH,
        ...
        // Actual text
        gDPPipeSync(gfx++);
        gDPSetPrimColor(gfx++, 0, 0, 255, 185, 31, sTextAlpha);
