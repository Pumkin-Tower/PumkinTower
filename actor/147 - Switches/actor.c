...
#define gEyeSwitchGoldOpenTex ((void*)0x0500ab60)
#define gEyeSwitchGoldOpeningTex ((void*)0x05009b60)
#define gEyeSwitchGoldClosingTex ((void*)0x0500a360)
#define gEyeSwitchGoldClosedTex ((void*)0x05009360)
#define gEyeSwitchSilverOpenTex ((void*)0x0500b430)
#define gEyeSwitchSilverHalfTex ((void*)0x0500bc30)
#define gEyeSwitchSilverClosedTex ((void*)0x0500c430)
#define gFloorSwitch1DL ((void*)0x0500ce78)
#define gFloorSwitch3DL ((void*)0x0500d070)
#define gFloorSwitch2DL ((void*)0x0500cf70)
#define gEyeSwitchGoldDL ((void*)0x05009290)
#define gEyeSwitchSilverDL ((void*)0x0500b360)
#define gFloorSwitchCol ((void*)0x0500ce48)
#define gCrystalSwitchTexAnim ((void*)0x0500d3a0)
#define gRustyFloorSwitchDL ((void*)0x0500cc30)
#define gCrystalSwitchBaseDL ((void*)0x0500d2e8)
#define gCrystalSwitchCoreDL ((void*)0x0500d170)
#define gCrystalSwitchDiamondDL ((void*)0x0500d248)
...
void ObjSwitch_SetSwitchFlagState(ObjSwitch* this, PlayState* play, s32 setFlag) {
    if (setFlag) {
        ...
        this->hackyTimer = this->hackyTimerInit;
    } else {
        s32 switchFlag = OBJ_SWITCH_GET_SWITCH_FLAG(&this->dyna.actor);
...
void ObjSwitch_Init(Actor* thisx, PlayState* play) {
    ...
    // how many seconds to 
    this->hackyTimerInit = this->dyna.actor.home.rot.x * 20/*seconds*/;
...
bool IsTouchingSwordBeam(ObjSwitch* this, PlayState* play)
{
    if (Actor_FindNearby(play, &this->dyna.actor, ACTOR_EN_M_THUNDER, ACTORCAT_ITEMACTION, 64))
        return true;
...
void ObjSwitch_CrystalSwitchOff(ObjSwitch* this, PlayState* play) {
    s32 switchHit = ((this->colliderJntSph.base.acFlags & AC_HIT) != 0) | IsTouchingSwordBeam(this, play);
...
void ObjSwitch_Update(Actor* thisx, PlayState* play) {
    ...
    // hacky timer
    if (this->hackyTimer > 0)
    {
        this->hackyTimer--;
        
        Actor_PlaySfx_FlaggedTimer(&this->dyna.actor, this->hackyTimer);
