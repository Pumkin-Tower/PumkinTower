...
asm(" \
gIronKnuckleWalkAnim = 0x06006294; \
gIronKnuckleWhiteArmorMaterialDL = 0x0600D0B0; \
gIronKnuckleBlackArmorMaterialDL = 0x0600D080; \
gIronKnuckleDeathAnim = 0x06004A04; \
gIronKnuckleVerticalAttackAnim = 0x06000CE8; \
gIronKnuckleFrontTorsoArmorMarkingDL = 0x0600A5D8; \
gIronKnuckleRivetsMarking2DL = 0x0600A820; \
gIronKnuckleBlockAnim = 0x0600391C; \
gIronKnuckleGoldArmorMaterialDL = 0x0600D0C8; \
gIronKnuckleSkel = 0x060136A0; \
gIronKnuckleEndHorizontalAttackAnim = 0x06002E7C; \
gIronKnuckleEndVerticalAttackAnim = 0x06001ABC; \
gIronKnuckleRearTorsoArmorMarkingDL = 0x0600A6D0; \
gIronKnuckleHelmetMarkingDL = 0x0600CF08; \
gIronKnuckleFrontHitAnim = 0x06005254; \
gIronKnuckleTanArmorMaterialDL = 0x0600D038; \
gIronKnuckleBackHitAnim = 0x0600367C; \
gIronKnuckleBronzeArmorMaterialDL = 0x0600D050; \
gIronKnuckleHorizontalAttackAnim = 0x06002484; \
gIronKnuckleRunAnim = 0x060057F4; \
gIronKnuckleRivetsMarking1DL = 0x0600A780; \
gIronKnuckleBrownArmorMaterialDL = 0x0600D098; \
gIronKnuckleRecoverVerticalAttackAnim = 0x060015F8; \
gIronKnuckleSilverArmorMaterialDL = 0x0600D068; \
");
...
void EnIk_PlayCutscene(EnIk* this, PlayState* play) {
    ...
    if (CutsceneManager_IsNext(this->actor.csId)) {
        if (this->actor.csId != CS_ID_NONE) {
            // don't play cutscene on death or armor break
...
void EnIk_Update(Actor* thisx, PlayState* play2) {
    ...
    if (this->actor.bgCheckFlags & UPDBGCHECKINFO_FLAG_4) {
        this->drawArmorFlags = 1;
        this->colliderCylinder.base.colType = 3;
        this->actor.colChkInfo.damageTable = &sDamageTableNoArmor;
        Actor_PlaySfx(&this->actor, NA_SE_EN_IRONNACK_ARMOR_OFF_DEMO);
