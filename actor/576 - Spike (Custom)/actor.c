...
#define gEnNyRockBodyDL (Gfx*)(0x06001dd0)
#define gEnNyMetalBodyDL (Gfx*)(0x06001ea8)
#define gEnNySpikeDL (Gfx*)(0x06001fc8)
...
static void Gfx_SetupDL_25Xlu(GraphicsContext* gfxCtx) {
    OPEN_DISPS(gfxCtx);
...
static void Gfx_SetupDL_25Opa(GraphicsContext* gfxCtx) {
    OPEN_DISPS(gfxCtx);
...
void EnNy_Move(EnNy* this, PlayState* play) {
    ...
    if ((stoneTimer <= 0) || (this->hitPlayer != false)) {
        ...
        yawDiff = Math_FAtan2F(this->actor.playerHeightRel, this->actor.xzDistToPlayer);
...
void EnNy_SetupDie(EnNy* this, PlayState* play) {
    ...
    if (this->timer >= 2) {
        ...
        Actor_PlaySfx(&this->actor, NA_SE_EV_NUTS_BROKEN);
