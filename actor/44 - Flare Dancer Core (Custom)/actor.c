...
static AnimationInfo sAnimationInfo[] = {
    { (void*)(0x06006CF8), 0.0f, 0.0f, -1.0f, ANIMMODE_ONCE_INTERP, 0.0f },
    { (void*)(0x06007CD0), 1.0f, 0.0f, -1.0f, ANIMMODE_ONCE_INTERP, -8.0f },
    { (void*)(0x06007DC8), 1.0f, 0.0f, -1.0f, ANIMMODE_LOOP_INTERP, -8.0f },
};
...
void EnFw_Init(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_InitFlex(play, &this->skelAnime, (void*)(0x06007c30), NULL, this->jointTable, this->morphTable, 11);
    Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimationInfo, ENFW_ANIM_0);
...
void EnFw_Run(EnFw* this, PlayState* play) {
    ...
    if (this->skelAnime.animation == (void*)(0x06006CF8)) {
        if (Animation_OnFrame(&this->skelAnime, this->skelAnime.endFrame) == 0) {
            ...
            Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimationInfo, ENFW_ANIM_2);
        }
        return;
    }
    ...
    if (this->explosionTimer != 0) {
        ...
        if (this->slideTimer == 0 && EnFw_PlayerInRange(this, play)) {
            Actor_PlaySfx(&this->actor, NA_SE_EN_STALBABY_SURPRISED);
...
void EnFw_TurnToParentInitPos(EnFw* this, PlayState* play) {
    ...
    if (ABS(angleToParentInit - this->actor.shape.rot.y) < 0x65) {
        ...
        Actor_ChangeAnimationByInfo(&this->skelAnime, sAnimationInfo, ENFW_ANIM_1);
...
void EnFw_Update(Actor* thisx, PlayState* play) {
    ...
    if (!CHECK_FLAG_ALL(this->actor.flags, ACTOR_FLAG_2000)) {
        ...
        Actor_UpdateBgCheckInfo(play, &this->actor, 10.0f, 20.0f, 0.0f, UPDBGCHECKINFO_FLAG_1 | UPDBGCHECKINFO_FLAG_4);
...
s32 EnFw_OverrideLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3f* pos, Vec3s* rot, Actor* thisx) {
    return false;
}

void EnFw_PostLimbDraw(PlayState* play, s32 limbIndex, Gfx** dList, Vec3s* rot, Actor* thisx) {
    EnFw* this = (EnFw*)thisx;
...
void EnFw_Draw(Actor* thisx, PlayState* play) {
    ...
    SkelAnime_DrawFlexOpa(play, this->skelAnime.skeleton, this->skelAnime.jointTable, this->skelAnime.dListCount,
                          EnFw_OverrideLimbDraw, EnFw_PostLimbDraw, (void*)this);
}
