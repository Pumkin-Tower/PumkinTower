...
#define gBoxChestOpenAnim ((void*)0x0600043c)
#define gBoxChestCol ((void*)0x060080e8)
#define gBoxChestSkel ((void*)0x060066a0)
#define gBoxBigChestOpenAdultAnim ((void*)0x0600024c)
#define gBoxBigChestOpenGoronAnim ((void*)0x06007e54)
#define gBoxBigChestOpenDekuAnim ((void*)0x06007f30)
#define gBoxBigChestOpenChildAnim ((void*)0x06000128)
#define gBoxChestBaseOrnateDL ((void*)0x06000db0)
#define gBoxChestBaseDL ((void*)0x060006f0)
#define gBoxChestBaseGildedDL ((void*)0x06000a50)
#define gBoxChestLidDL ((void*)0x060012e8)
#define gBoxChestLidOrnateDL ((void*)0x06001d58)
#define gBoxChestLidGildedDL ((void*)0x06001850)
...
//#define ENBOX_GET_SWITCH_FLAG(thisx) ((thisx)->world.rot.z) // original method
#define ENBOX_GET_SWITCH_FLAG(thisx) ((((int)(thisx)->home.pos.x) & 0b0111) | ((((int)(thisx)->home.pos.z) & 0b1111) << 3)) // new method
