...
asm("object_bombiwa_DL_0009E0 = 0x060009E0;");
asm("object_bombiwa_DL_005990 = 0x06005990;");
asm("object_bombiwa_DL_000AF0 = 0x06000AF0;");
asm("object_bombiwa_DL_004560 = 0x06004560;");
asm("object_bombiwa_DL_004688 = 0x06004688;");
asm("object_bombiwa_DL_005990 = 0x06005990;");
...
void ObjBombiwa_Init(Actor* thisx, PlayState* play) {
    ...
    if ((thisx->params & 0x00ff) != 0x00ff
        && Flags_GetSwitch(play, OBJBOMBIWA_GET_SWITCH_FLAG(&this->actor))
    ) {
...
void func_80939EF4(ObjBombiwa* this, PlayState* play) {
    ...
    if (sp28->unk_0C(&this->actor)) {
        if ((this->actor.params & 0x00ff) != 0x00ff)
