...
asm(" \
gGoronElderTakeOutDrumAnim = 0x06011F50; \
gGoronElderWavingAnim = 0x0600BDD8; \
gGoronElderCradleAnim = 0x0600A07C; \
gGoronElderHeadShakeAnim = 0x0600C7A8; \
gGoronElderSurpriseLoopAnim = 0x0600E8FC; \
gGoronElderSkel = 0x0601AFF0; \
gGoronElderDepressedAnim = 0x06018CE4; \
gGoronElderPlayingDrumAnim = 0x06013DD8; \
gGoronElderThinkingAnim = 0x060077CC; \
gGoronElderAngryAnim = 0x0601436C; \
gGoronElderRememberingAnim = 0x0600D630; \
gGoronElderSurpriseStartAnim = 0x0600DB54; \
gGoronElderIdleAnim = 0x0601ADC0; \
gGoronElderStrongRememberingAnim = 0x0600FE48; \
gGoronElderDrumIdleAnim = 0x060129F4; \
gGoronElderWalkAnim = 0x06009440; \
");
...
s32 EnJg_GetStartingConversationTextId(EnJg* this, PlayState* play) {
    ...
    if (!EN_JG_IS_IN_GORON_SHRINE(&this->actor)) {
        if (false && player->transformation == PLAYER_FORM_GORON) { // XXX same text for all link forms
