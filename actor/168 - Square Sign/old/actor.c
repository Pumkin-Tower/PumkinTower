...
// TODO use GBI stuff
static const u8 gEnKanban_D_80957DA0[64] = {
    0xF8, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 
    0x07, 0xD0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x04, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 
    0x07, 0xD0, 0x17, 0x70, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 
    0xF8, 0x30, 0x17, 0x70, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF
};

// TODO use GBI stuff
static u8 gEnKanban_D_80957DE0[128] = {
    0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xE3, 0x00, 0x10, 0x01, 0x00, 0x00, 0x00, 0x00, 
    0xD7, 0x00, 0x00, 0x02, 0xFF, 0xFF, 0xFF, 0xFF, 0xFD, 0x90, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 
    0xF5, 0x90, 0x00, 0x00, 0x07, 0x09, 0x82, 0x60, 0xE6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0xF3, 0x00, 0x00, 0x00, 0x07, 0x1F, 0xF2, 0x00, 0xE7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
    0xF5, 0x88, 0x08, 0x00, 0x00, 0x09, 0x82, 0x60, 0xF2, 0x00, 0x00, 0x00, 0x00, 0x07, 0xC0, 0x7C, 
    0xFC, 0x30, 0x97, 0xFF, 0xFF, 0xFF, 0xFE, 0x38, 0xE2, 0x00, 0x00, 0x1C, 0x0C, 0x18, 0x4F, 0x50, 
    0xD9, 0xF0, 0xFB, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x40, 0x08, 0x80, 0x95, 0x7D, 0xA0, 
...
void EnKanban_Init(Actor* thisx, PlayState* play) {
    ...
    // hacky way to update vertex buffer pointer in embedded display list
    //*((u32*)(gEnKanban_D_80957DE0 + 0x3c)) = (u32)gEnKanban_D_80957DA0;
...
void EnKanban_Draw(Actor* thisx, PlayState* play) {
    ...
    if ((this->actor.projectedPos.z <= 400.0f) && (this->actor.projectedPos.z > 0.0f) &&
        ...
        gSPSegment(POLY_XLU_DISP++, 0x08, shadowTex);
        //gSPDisplayList(POLY_XLU_DISP++, gEnKanban_D_80957DE0); // TODO this crashes, no shadow for now
    }
