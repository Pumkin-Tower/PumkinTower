...
#if 1
extern Vtx gEnHollCentralPlaneVtx[];
extern Gfx gEnHollCentralPlaneDL[];
Vtx gEnHollCentralPlaneVtx[] = {
	VTX(18000, 22000, 0, 2048, 2048, 255, 255, 255, 255),
	VTX(-18000, 22000, 0, 0, 2048, 255, 255, 255, 255),
	VTX(-18000, -22000, 0, 0, 0, 255, 255, 255, 255),
	VTX(18000, -22000, 0, 2048, 0, 255, 255, 255, 255),
};
Gfx gEnHollCentralPlaneDL[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPSetCombineMode(G_CC_PRIMITIVE, G_CC_PASS2),
    gsSPVertex(gEnHollCentralPlaneVtx, 4, 0),
...
void EnHoll_ChangeRooms(PlayState* play) {
    ...
    // respawn the player here if they void out
